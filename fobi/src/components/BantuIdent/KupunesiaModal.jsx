...
import { faMapMarkerAlt, faCalendar, faUser, faTag, faButterfly } from '@fortawesome/free-solid-svg-icons';

const KupunesiaModal = ({ isOpen, onClose, observation }) => {
    return (
