...
function ButterflyQualityAssessment({ checklist }) {
    const assessments = [
        {
            id: 'has_photo',
            label: 'Memiliki Foto',
            value: checklist.media && checklist.media.length > 0,
            description: 'Observasi dilengkapi dengan foto kupu-kupu'
        },
        {
            id: 'has_location',
        ...
        {
            id: 'has_habitat_info',
            label: 'Informasi Habitat',
            value: !!checklist.habitat_notes,
            description: 'Informasi tentang habitat kupu-kupu tercatat'
        }
    ];
...
export default ButterflyQualityAssessment; 